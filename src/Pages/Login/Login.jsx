...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center py-16'>
      <div className='flex w-full bg-gray-900   gap-8 items-center lg:flex-row flex-col  mx-auto overflow-hidden  rounded-lg shadow-lg  lg:max-w-4xl '>
        ...
        <div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
          ...
          <div onClick={() => handleSocialLogin(googleLogin)} className='flex cursor-pointer items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg   hover:bg-gray-50 '>
